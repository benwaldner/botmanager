...
payloads, explicit finalized-flag validation, control response parsing,
...
- public kline frame parsing, timestamp/OHLCV/finalized-flag validation, supported-interval validation, data/kline symbol validation, and combined-stream symbol/interval mismatch rejection;
