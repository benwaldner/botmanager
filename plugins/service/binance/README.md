...
and finalized-flag validation, subscribe/unsubscribe payloads, control response id parsing,
...
- public WebSocket control response parsing, including fail-closed request id validation;
