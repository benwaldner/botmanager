...
fail-closed timestamp, OHLCV, trade-count, and finalized-flag validation,
subscribe/unsubscribe payloads, control response parsing, supported-interval
validation, combined stream URLs, in-memory subscription state, finalized bar
...
- public kline frame parsing, timestamp/OHLCV/trade-count/finalized-flag validation, supported-interval validation, data/kline symbol validation, and combined-stream symbol/interval mismatch rejection;
