...
id/error-code/error-message/result-list stream parsing,
...
- public kline frame parsing, integer-timestamp/string-field/OHLCV/trade-count/finalized-flag validation, supported-interval validation, data/kline symbol validation, and combined-stream type/symbol/interval mismatch rejection;
...
- public WebSocket control response parsing, including fail-closed request id, error code, error message, and result-list stream validation;
