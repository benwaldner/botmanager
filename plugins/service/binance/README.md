...
symbol/string-field, finite OHLCV, trade-count,
and finalized-flag validation, subscribe/unsubscribe payloads, control response
root-object/id/error-code/error-message/result-list stream parsing,
...
- public kline frame parsing, root/data/k-object/event/open/close integer-timestamp/symbol/string-field/finite-OHLCV/trade-count/finalized-flag validation, supported-interval validation, data/kline symbol validation, stream-builder symbol validation/fail-closed output behavior, and combined-stream type/symbol/interval mismatch rejection;
