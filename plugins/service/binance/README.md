...
id/error-code/result-list stream parsing,
...
- public WebSocket control response parsing, including fail-closed request id, error code, and result-list stream validation;
